...
const CTA = () => {
  return (
    <>
      ...
      <section className="relative bg-darkGreen px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            <h2 className="text-white font-roboto font-bold text-2xl md:text-4xl md:text-center md:leading-normal lg:text-left">
              Get the news of our latest events delivered From us to your inbox weekly.
            </h2>
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              ...
              />
              <button className="px-4 py-3 rounded-lg w-full bg-darkBlue text-white font-bold md:w-fit md:whitespace-nowrap">
                Get started
              </button>
            </div>
            <p className="text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
              <span className="font-bold italic text-[#C6DCD0] md:not-italic md:font-normal md:text-dark-light">
                Subscribe to Our Newsletter
              </span>{" "}
              to always stay connected with your society and never miss any upcoming events.
            </p>
          </div>
          <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last">
            <div className="w-3/4 mx-auto relative">
              <div className="w-1/2 h-1/2 bg-[#C6DCD0] rounded-lg absolute top-[10%] -right-[8%]" />
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                ...
                <div className="p-5">
                  ...
                  <p className="text-dark-light mt-3 text-sm md:text-lg">
                    Stay connected and never miss the amazing events.
                  </p>
                </div>
              </div>
            </div>
